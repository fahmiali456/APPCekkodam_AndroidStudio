...
import com.dicoding.picodiploma.loginwithanimation.view.result.ResultActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Cek session, jika tidak login kembali ke WelcomeActivity
        ...
        setupView()
        setupSearchAction()
        setupLogoutAction() // Tambahkan ini
        playAnimation()
    }
    ...
    private fun setupSearchAction() {
        ...
        binding.btnCheck.setOnClickListener {
            ...
            if (inputName.isNotEmpty()) {
                // Pindah ke ResultActivity dengan membawa nama
